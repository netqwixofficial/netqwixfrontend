...
const DashboardFriendsPage = () => {
  ...
  useEffect(() => {
    // Set the active tab to Friends
    dispatch(authAction.setTopNavbarActiveTab(topNavbarOptions.Friends));
...
export default DashboardFriendsPage;
